...
public class HttpClientUtils {
	...
	public String doSSLPost(String url, String charset,Map<String, String> paramMap) throws Exception {
		...
		try {
			...
			post.setHeader("User-Agent", "Mozilla/5.0 (Linux; Android 6.0; Lenovo K50-t5 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/46.0.2490.76 Mobile Safari/537.36 AliApp(DingTalk/2.7.6) com.alibaba.android.rimet/0");
